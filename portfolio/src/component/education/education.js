                  ...
                  <div className={classes.timeline_centered}>
                    ...
                    >
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          ...
                          <p>
                            I have completed my higher education from HKIS with
                            major subjects as Physics,Chemistry & Maths with 85
                            merit in CBSE board.{" "}
                          </p>
                        </div>
                      </article>
                    ...
                    >
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          <h2>
                            Undergraduation at SLIET <span>2017-Present</span>
                          </h2>
                          <p>
                            I'm currently completing my undergraduation in CSE
                            (Computer Science and Engineering) from{" "}
                            <a href="http://sliet.ac.in/">SLIET</a>.{" "}
                          </p>
                        </div>
                      </article>
                    </ScrollAnimation>
